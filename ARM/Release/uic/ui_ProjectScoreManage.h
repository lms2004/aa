...
public:
    ...
    void setupUi(QWidget *ProjectScoreManage)
    {
        ...
        Widget1->setGeometry(QRect(140, 10, 401, 201));
        ...
        pushButton_3 = new QPushButton(ProjectScoreManage);
        pushButton_3->setObjectName("pushButton_3");
        pushButton_3->setGeometry(QRect(250, 180, 80, 24));
        pushButton_3->raise();
        label_2->raise();
        label->raise();
        ProjectPath->raise();
        ...
        label_6->raise();
        pushButton->raise();
        SetProjectYorN->raise();
        Widget1->raise();
        label_7->raise();
        deleteproject->raise();
        pushButton_2->raise();
        deletefalse_1->raise();
        deleteproject_true->raise();
        deletefalse_2->raise();
        projectpaixu->raise();
        ...
        QObject::connect(pushButton_3, SIGNAL(clicked()), ProjectScoreManage, SLOT(uploadGo()));
    ...
    void retranslateUi(QWidget *ProjectScoreManage)
    {
        ...
        pushButton_3->setText(QCoreApplication::translate("ProjectScoreManage", "\344\270\212\344\274\240\346\226\207\344\273\266", nullptr));
    } // retranslateUi
