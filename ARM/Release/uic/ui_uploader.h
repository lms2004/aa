...
public:
    ...
    void setupUi(QWidget *uploader)
    {
        ...
        projectPathLineEdit->setGeometry(QRect(20, 90, 391, 41));
        ...
        statusLabel->setGeometry(QRect(10, 0, 461, 101));
        label = new QLabel(uploader);
        label->setObjectName("label");
        label->setGeometry(QRect(10, 70, 231, 20));
        SSh_Address = new QLineEdit(uploader);
        SSh_Address->setObjectName("SSh_Address");
        SSh_Address->setGeometry(QRect(20, 250, 341, 41));
        SSH_Label = new QLabel(uploader);
        SSH_Label->setObjectName("SSH_Label");
        SSH_Label->setGeometry(QRect(20, 220, 341, 20));
        repoPath_ = new QLineEdit(uploader);
        repoPath_->setObjectName("repoPath_");
        repoPath_->setGeometry(QRect(20, 170, 391, 41));
        repoPath__Label = new QLabel(uploader);
        repoPath__Label->setObjectName("repoPath__Label");
        repoPath__Label->setGeometry(QRect(20, 140, 471, 16));
        browseButton1 = new QPushButton(uploader);
        browseButton1->setObjectName("browseButton1");
        browseButton1->setGeometry(QRect(430, 180, 81, 31));
        branchName = new QLineEdit(uploader);
        branchName->setObjectName("branchName");
        branchName->setGeometry(QRect(400, 250, 81, 41));
        branchName_2 = new QLabel(uploader);
        branchName_2->setObjectName("branchName_2");
        branchName_2->setGeometry(QRect(380, 220, 141, 16));
    ...
    void retranslateUi(QWidget *uploader)
    {
        ...
        SSH_Label->setText(QCoreApplication::translate("uploader", "\350\257\267\350\276\223\345\205\245\345\257\271\345\272\224\347\232\204SSH\344\273\223\345\272\223\345\234\260\345\235\200\357\274\210\345\220\246\345\210\231\345\217\226\351\273\230\350\256\244\345\200\274\357\274\211", nullptr));
        repoPath__Label->setText(QCoreApplication::translate("uploader", "\350\257\267\350\276\223\345\205\245\345\257\271\345\272\224\347\232\204\346\234\254\345\234\260\345\255\230\345\202\250\344\273\223\345\272\223\345\234\260\345\235\200\357\274\210\345\220\246\345\210\231\345\217\226\351\273\230\350\256\244\345\200\274\357\274\211", nullptr));
        browseButton1->setText(QCoreApplication::translate("uploader", "\346\265\217\350\247\210", nullptr));
        branchName_2->setText(QCoreApplication::translate("uploader", "\345\275\223\345\211\215\346\216\250\351\200\201\345\210\206\346\224\257\357\274\232", nullptr));
    } // retranslateUi
